...
exports.paginateListAgentStatuses = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new ListAgentStatusesCommand_1.ListAgentStatusesCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.listAgentStatuses(input, ...args);
};
async function* paginateListAgentStatuses(config, input, ...additionalArguments) {

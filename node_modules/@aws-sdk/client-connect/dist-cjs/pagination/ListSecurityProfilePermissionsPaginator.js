...
exports.paginateListSecurityProfilePermissions = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new ListSecurityProfilePermissionsCommand_1.ListSecurityProfilePermissionsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.listSecurityProfilePermissions(input, ...args);
};
async function* paginateListSecurityProfilePermissions(config, input, ...additionalArguments) {

...
var UpdateAgentStatusCommand = (function (_super) {
    ...
    function UpdateAgentStatusCommand(input) {
        var _this = _super.call(this) || this;
        _this.input = input;
        return _this;
    }
    UpdateAgentStatusCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "ConnectClient";
        var commandName = "UpdateAgentStatusCommand";
    ...
    UpdateAgentStatusCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1UpdateAgentStatusCommand(input, context);
    };
    UpdateAgentStatusCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1UpdateAgentStatusCommand(output, context);
    };
    return UpdateAgentStatusCommand;
}($Command));
export { UpdateAgentStatusCommand };
